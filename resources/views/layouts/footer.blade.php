...
<div class="container">
  ...
  <div class="row">
    <div class="col-6 col-md-4 col-lg-3 col-xxl-2 mb-3">
      <h5 class="lh-lg fw-bold text-white">Tentang Kami</h5>
      <ul class="list-unstyled mb-md-4 mb-lg-0">
        <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Tentang Warung</a></li>
        <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Tim</a></li>
    ...
    <div class="col-6 col-md-4 col-lg-3 col-xxl-2 col-lg-3 mb-3">
      ...
      <ul class="list-unstyled mb-md-4 mb-lg-0">
        <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Bantuan</a></li>
        <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Kontak </a></li>
        <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Informasi Lanjut</a></li>
      </ul>
    </div>
    <div class="col-12 col-md-8 col-lg-6 col-xxl-4">
      <h5 class="lh-lg fw-bold text-500">FOLLOW US</h5>
      <div class="text-start my-3"> <a href="https://www.instagram.com/kopiklotok/">
      ...
      <h3 class="text-500 my-4">Dapatkan penawaran eksklusif dan<br />Diskon di kotak surat Anda</h3>
  ...
  <div class="row flex-center pb-3">
    <div class="col-md-6 order-0">
      <p class="text-200 text-center text-md-start">All rights Reserved &copy; Your Company, 2022</p>
    </div>
    <div class="col-md-6 order-1">
      <p class="text-200 text-center text-md-end"> Made with&nbsp;
        ...
        </svg>&nbsp;by&nbsp;<a class="text-200 fw-bold" href="https://themewagon.com/" target="_blank">Y Team </a>
      </p>
    </div>
  </div>
